      subroutine hp_a1sr0g(Ta2,lam,res)
      implicit none
      include 'hp_types.h'
...
!##### ORDER EPS^2 #####
      ...
      ab(1)=2*ab(2) + ab(1)
      ab(1)=l1*ab(1)
      ab(2)= - 4.0_ki/3.0_ki*l2 - 1.0_ki/20.0_ki*ab(4)
      ab(2)=ab(2)*ab(3)
      ab(3)=l2**3
      ab(3)=zeta3 + 2.0_ki/3.0_ki*ab(3)
      ab(1)=2*ab(1) + 8*ab(3) + ab(2)

!--- include file for double soft ct's
      ...
      d2 = cli2((cone*(xa - xb))/(-1 + xa))
      d3 = cli2(-(cone*xa))
      d4 = cli2(cone*xa)
      d5 = cli2((cone*(1 - xa))/(1 + Sqrt(xa)*Sqrt(xb)))
      d6 = cli2((cone*(1 - xa))/(1 - xb))
      d7 = cli2((cone*Sqrt(xb))/Sqrt(xa))
      d8 = cli2(-(cone*xb))
      d9 = cli2(cone*xb)
      d10 = cli2((cone*xb)/xa)
      d11 = cli2(cone*xa*xb)
      ...
      d14 = cli2((cone*(1 - xa))/(1 - xa*xb))
      d15 = cli2((cone*(1 - xb))/(1 - xa*xb))
      d16 = cli2((cone*(1 - xa*xb))/(1 + xb))
      d17 = cli2((cone*(1 - xa)*xa)/(xa - xa*xb))
      d18 = cli2((cone*(xa - xa*xb))/(xa + Sqrt(xa)*Sqrt(xb)))

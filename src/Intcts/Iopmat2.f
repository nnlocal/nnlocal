...
c---  A2 Integrated counterterms
      ...
      call a2carsggg(xa,xb,ABa2carsggg)
      call a2carbsgggg(xa,xb,ABa2carbsgggg)
      call a2carsggg_bulk(xa,xb,res)
      ABa2carsggg(2,2,-4:0)=res(2,2,-4:0)
      call a2carbsgggg_bulk(xa,xb,res)
      ABa2carbsgggg(2,2,-4:0)=res(2,2,-4:0)

      call a2carsggg(xb,xa,BAa2carsggg)
      call a2carbsgggg(xb,xa,BAa2carbsgggg)
      call a2carsggg_bulk(xb,xa,res)
      BAa2carsggg(2,2,-4:0)=res(2,2,-4:0)
      call a2carbsgggg_bulk(xb,xa,res)
      ...
      k=1
      call addscale2(k,tmp2,tmpab2,xl12)
      call fillIop2_1(g,g,g,g,k,tmp2)
      
      call addscale2(k,tmp2,tmpba2,xl12)
      call fillIop2_2(g,g,g,g,k,tmp2)
      
c---
      
      call a2srsgg(CA,xa,ABa2srsgg)
      call a2srsgg(CA,xb,BAa2srsgg)
      call a2carssrsgg(CA,xa,ABa2carssrsgg)
      call a2carssrsgg(CA,xb,BAa2carssrsgg)
      call a2carbssrsgg(CA,CA,xa,ABa2carbssrsgg)
      call a2carbssrsgg(CA,CA,xb,BAa2carbssrsgg)
      ...
      k=0
      call addscale2(k,tmp3,tmpab3,xl12)
      call fillIop2_1(g,g,g,g,k,tmp3)
...
c---  A12 Integrated counterterms
      ...
      call a12carscrsggg(xa,xb,ABa12carscrsggg)
      call a12carscrsggg(xb,xa,BAa12carscrsggg)
      call a12carscasggg(xa,xb,ABa12carscasggg)
      call a12carscasggg(xb,xa,BAa12carscasggg)
      call a12casbrcasgggg(xa,xb,ABa12casbrcasgggg)
      call a12casbrcasgggg(xb,xa,BAa12casbrcasgggg)
...
c---
      ...
      call a12srscrsgg(CA,xa,ABa12srscrsgg)
      call a12srscrsgg(CA,xb,BAa12srscrsgg)
      call a12carssrscrsgg(CA,xa,ABa12carssrscrsgg)
      call a12carssrscrsgg(CA,xb,BAa12carssrscrsgg)
      call a12carssrsssgg(CA,xa,ABa12carssrsssgg)
      call a12carssrsssgg(CA,xb,BAa12carssrsssgg)
      call a12srsssgg(CA,xa,ABa12srsssgg)
      call a12srsssgg(CA,xb,BAa12srsssgg)
      call a12carssrscasssgg(CA,xa,ABa12carssrscasssgg)
      call a12carssrscasssgg(CA,xb,BAa12carssrscasssgg)
      call a12srscasssgg(CA,xa,ABa12srscasssgg)
      call a12srscasssgg(CA,xb,BAa12srscasssgg)

      call a12carscrsssggg(xa,xb,ABa12carscrsssggg)
      call a12carscrsssggg(xb,xa,BAa12carscrsssggg)
      call a12carsssggg(xa,xb,ABa12carsssggg)
      call a12carsssggg(xb,xa,BAa12carsssggg)
      call a12carscasssggg(xa,xb,ABa12carscasssggg)
      call a12carscasssggg(xb,xa,BAa12carscasssggg)
...
c---  A1A1 Integrated counterterms
      ...
      call a1a1carcasggg(xa,xb,ABa1a1carcasggg)
      call a1a1carcasggg(xb,xa,BAa1a1carcasggg)
      call a1a1cbrcasgggg(xa,xb,ABa1a1cbrcasgggg)
      call a1a1cbrcasgggg(xb,xa,BAa1a1cbrcasgggg)
      call a1a1crscasggg(xa,xb,ABa1a1crscasggg)
      call a1a1crscasggg(xb,xa,BAa1a1crscasggg)
...
c---
      ...
      call a1a1cassscarsragg(CA,xa,ABa1a1cassscarsragg)
      call a1a1cassscarsragg(CA,xb,BAa1a1cassscarsragg)
      call a1a1cassssragg(CA,xa,ABa1a1cassssragg)
      call a1a1cassssragg(CA,xb,BAa1a1cassssragg)
      call a1a1sscarsragg(CA,xa,ABa1a1sscarsragg)
      call a1a1sscarsragg(CA,xb,BAa1a1sscarsragg)
      call a1a1sssrgg(CA,xa,ABa1a1sssrgg)
      call a1a1sssrgg(CA,xb,BAa1a1sssrgg)      

      call a1a1crssscarggg(xa,xb,ABa1a1crssscarggg)
      call a1a1crssscarggg(xb,xa,BAa1a1crssscarggg)
      call a1a1sscarggg(xa,xb,ABa1a1sscarggg)
      call a1a1sscarggg(xb,xa,BAa1a1sscarggg)
...
c---  RVA1 Integrated counterterms
      ...
      call rva1ncar1gg(xa,xb,ABrva1ncar1gg)
      call rva1ncar1gg(xb,xa,BArva1ncar1gg)
...
c---
      ...
      call rva1sr1g(CA,xa,ABrva1sr1g)
      call rva1sr1g(CA,xb,BArva1sr1g)
      call rva1carsr1g(CA,xa,ABrva1carsr1g)
      call rva1carsr1g(CA,xb,BArva1carsr1g)
...
c---  A1 Integrated counterterms
      ...
      call a1ncar0gg(xa,xb,ABa1ncar0gg)
      call a1ncar0gg(xb,xa,BAa1ncar0gg)
...
c      call a1sr0g(CA,xa,ABa1sr0g)
c      call a1sr0g(CA,xb,BAa1sr0g)

c      call a1carsr0g(CA,xa,ABa1carsr0g)
c      call a1carsr0g(CA,xb,BAa1carsr0g)

      tmpab1=ABa1ncar0gg!+half*ABa1sr0g-ABa1carsr0g

      tmpba1=BAa1ncar0gg!+half*BAa1sr0g-BAa1carsr0g
      
      call addscale1(tmp1,tmpab1,xl12)
      call fillIop1_1(g,g,g,1,tmp1)
...
c--- Renormalization of the I2
      ...
      call addscale3(tmp2,tmpab1,-xl12)
      call fillIop2_1(g,g,g,g,1,tmp2)
...
c---  C1A1 Integrated counterterms
      ...
      call a1c1cargggg(xa,xb,ABa1c1cargggg)
      call a1c1cargggg(xb,xa,BAa1c1cargggg)
      call a1c1cbrgggg(xa,xb,ABa1c1cbrgggg)
      call a1c1cbrgggg(xb,xa,BAa1c1cbrgggg)
...
c---  xlfs=Log[Q^2/muF^2]
      ...
      call addscale3(tmp,tmpab1,xlfs)
...
c     Convert input function with no eps dependence into eps-vector also adding
c     scale dependence (muR2/muF2)^(ep) and the 1/eps pole
      call addscale1c(tmp1,ABPgg0,xlrf,1,1)
c     Accumulate the I10 operator which will be multiplied by the OneLoop ME
      call fillIop1_1(g,g,g,1,tmp1)

c     Convert input function with no eps dependence into eps-vector also adding
c     scale dependence (muR2/muF2)^(ep) and the 1/eps pole
      call addscale1c(tmp1,BAPgg0,xlrf,1,1)
c     Accumulate the I10 operator which will be multiplied by the OneLoop ME
      call fillIop1_2(g,g,g,1,tmp1)
...
c     scale dependence (muR2/muF2)^(2 ep) and the 1/(2 eps) pole
      ...
      call addscale2c(tmp2,tempfcn,xlrf,1,2)
...
c     scale dependence (muR2/muF2)^(ep) and the -beta0/(eps^2) pole
      tempfcn = -ABPgg0*b0!/2.0_ki
      call addscale2c(tmp2,tempfcn,xlrf,2,1)
c     Accumulate the I20 operator which will be multiplied by the Born ME
      call fillIop2_1(g,g,g,g,1,tmp2)
...
c     Accumulate the I20 operator which will be multiplied by the Born ME
      ...
      subroutine fillIop2_1(a,b,c,d,i,Iopin)
      implicit none
      include 'types.h'
      include 'Ioperators2.f'
     ...
     2              +Iopin(j,k,eps)
      ...
      subroutine fillIop2_2(a,b,c,d,i,Iopin)
      implicit none
      include 'types.h'
      include 'Ioperators2.f'
      integer a,b,c,d,i,j,k,eps
     ...
     2              +Iopin(j,k,eps)
      ...
      subroutine fillIop1_1(a,b,c,i,Iopin)
      implicit none
      include 'types.h'
      include 'Ioperators2.f'
     ...
     2              +Iopin(j,k,eps)
      ...
      subroutine fillIop1_2(a,b,c,i,Iopin)
      implicit none
      include 'types.h'
      include 'Ioperators2.f'
      integer a,b,c,i,j,k,eps
     ...
     2              +Iopin(j,k,eps)
      ...
      subroutine addscale3(outarr,inarr,xlfs)
      implicit none
      include 'types.h'
      include 'constants.h'
      integer i,j
     ...
     3           +inarr(i,j,-2)*(xlfs*pisq/6.0_ki+xlfs**3/3.0_ki+2*zeta3/3.0_ki)/2.0_ki
      ...
      subroutine addscale2(k,outarr,inarr,xl12)
      implicit none
      include 'types.h'
      integer i,j,k
     ...
     4           +inarr(i,j,-4)*2/3.0_ki*xl12**4
      ...
      subroutine addscale1(outarr,inarr,xl12)
      implicit none
      include 'types.h'
      integer i,j
     ...
     4           +inarr(i,j,-2)/24.0_ki*xl12**4
      ...
      subroutine addscale2c(outarr,infunc,xlrs,epspoleorder,logpower)
      implicit none
      include 'types.h'
      include 'constants.h'

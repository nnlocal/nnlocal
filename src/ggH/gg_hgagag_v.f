...
c      if ((j.gt.0).and.(k.eq.-j)) msq(j,k)=aveqq*fac*virtqa
c      if ((j.lt.0).and.(k.eq.-j)) msq(j,k)=aveqq*fac*virtaq
c      if ((j.eq.0).and.(k.ne.0)) msq(j,k)=aveqg*fac*virtgq
c      if ((j.ne.0).and.(k.eq.0)) msq(j,k)=aveqg*fac*virtqg
      enddo
      enddo

...
c      msqv(0,0)=ason2pi*xn*2d0*(
c     .  -epinv*(epinv2-xl12)-0.5d0*xl12**2+11d0/6d0+0.5d0*pisq
c     .  -((11d0-two*dble(nf)/xn)*epinv-1d0)/6d0)*msq(0,0)

      msqv(0,0)=ason2pi*xn*2d0*(
     .     -epinv*(epinv2-xl12)
     .     -0.5d0*xl12**2+0.5d0*pisq +11d0/6d0
     .     -((11d0-0d0*two*dble(nf)/xn)*epinv)/6d0
     . )*msq(0,0)

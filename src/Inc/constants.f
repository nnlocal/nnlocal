...
!      - continuation lines are avoided
      ...
      double precision twopi,fourpi,pion4,pion10,pisqm8,rt2onpi,po2log
      ...
      parameter(zeta3=1.20205690315959428539973816151144999d0)
! sqrt(2d0/pi)
      parameter(rt2onpi=0.797884560802865d0)
      PARAMETER (PO2LOG = 0.45158270528945D0)
      double precision plg4half
      parameter(plg4half=0.5174790616738993863307581618988629d0)
!-----------------------------------------------------
